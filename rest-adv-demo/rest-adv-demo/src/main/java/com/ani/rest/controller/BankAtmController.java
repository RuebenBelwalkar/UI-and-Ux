...
public class BankAtmController {
    ...
    public ResponseEntity<AppResponse<Integer>> update(@RequestBody BankAccountDto requestDto) {
    ...
    public ResponseEntity<AppResponse<Integer>> delete(@PathVariable Long id ) {

        Integer st = service.deleteAccount(id);
